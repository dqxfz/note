...
public interface CoordinationService {
    ...
    void dealPrincipal(WebSocketSession session, Principal principal, Map<String, String> textMap, Map<String, HashSet<WebSocketSession>> sessionMap) throws Exception;
